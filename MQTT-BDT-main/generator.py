...
# MQTT setup
client = mqtt.Client()
client.connect("localhost", 1883, 60)  # Replace with your MQTT broker address
client.loop_start()
...
for data in synthetic_data:
    client.publish("wildfire/data", json.dumps(data))
    time.sleep(1)  # Wait a bit before sending the next message
    
with open('synthetic_weather_data.json', 'w', encoding='utf-8') as outfile:
